...
public sealed class AppLocalizer : INotifyPropertyChanged
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        ["NoRecentSources"] = "No recent items",
        ...
        ["ExportAnimatorGltf"] = "Export Animator as glTF / GLB…",
        ["ExportSceneModel"] = "Export selected scene model as FBX…",
        ["ExportSceneModelGltf"] = "Export selected scene model as glTF / GLB…",
        ...
        ["DragToResizeColumn"] = "Drag to resize column, double-click to reset",
        ["NoContainerGroup"] = "No container",
        ["ContainerDirectory"] = "Containers",
        ["AllAssets"] = "All Assets",
        ["ClearFilter"] = "Show all",
        ["CurrentContainer"] = "Container: {0}",
        ["ContainerItemCount"] = "{0} items",
        ["BuildingContainerTree"] = "Building container directory tree…",
        ["ContainerTreeLoaded"] = "Loaded {0} root directories",
        ["ContainerTreeSummary"] = "{0} items organized by container path",
        ["Previous"] = "Previous",
        ["Next"] = "Next",
        ["Preview"] = "Preview",
        ...
        ["GltfExport"] = "glTF / GLB export",
        ["GltfFormat"] = "glTF format",
        ["GltfScaleFactor"] = "glTF scale factor",
        ["Cancel"] = "Cancel",
        ["Save"] = "Save",
        ...
        ["ExportingAnimatorGltf"] = "Loading the selected AssetBundle and exporting Animator glTF / GLB…",
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChineseStrings = new Dictionary<string, string>
    {
        ...
        ["OpenRecent"] = "最近打开",
        ["ClearRecentList"] = "清空最近打开记录",
        ["NoRecentSources"] = "无近期记录",
        ...
        ["ExportAnimatorGltf"] = "将 Animator 导出为 glTF / GLB…",
        ["ExportSceneModel"] = "将选中的场景模型导出为 FBX…",
        ["ExportSceneModelGltf"] = "将选中的场景模型导出为 glTF / GLB…",
        ...
        ["Size"] = "大小",
        ["SizeMegabytes"] = "大小 (MB)",
        ["DragToResizeColumn"] = "拖动调整列宽，双击重置",
        ["NoContainerGroup"] = "未分类资源 (无容器路径)",
        ["ContainerDirectory"] = "容器目录",
        ["AllAssets"] = "全部资源",
        ["ClearFilter"] = "显示全部",
        ["CurrentContainer"] = "容器: {0}",
        ["ContainerItemCount"] = "{0} 项资源",
        ["BuildingContainerTree"] = "正在构建容器目录树…",
        ["ContainerTreeLoaded"] = "已加载 {0} 个根目录",
        ["ContainerTreeSummary"] = "共 {0} 项资源，按容器目录组织",
        ["Previous"] = "上一页",
        ["Next"] = "下一页",
        ["Preview"] = "预览",
        ...
        ["GltfExport"] = "glTF / GLB 导出",
        ["GltfFormat"] = "glTF 格式",
        ["GltfScaleFactor"] = "glTF 缩放系数",
        ["Cancel"] = "取消",
        ["Save"] = "保存",
        ...
        ["ExportingAnimator"] = "正在加载所选 AssetBundle 并导出 Animator FBX…",
        ["ExportingAnimatorGltf"] = "正在加载所选 AssetBundle 并导出 Animator glTF / GLB…",
