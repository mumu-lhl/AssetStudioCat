...
public sealed class AppLocalizer : INotifyPropertyChanged
{
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChineseStrings = new Dictionary<string, string>
    {
        ...
        ["ExportCompleteDump"] = "导出完整对象 Dump",
        ["TextDump"] = "文本 Dump",
        ...
        ["SelectAssetLoadDump"] = "选择资源，然后点击“加载 Dump”。",
        ["ChooseLoadDump"] = "点击“加载 Dump”以检查此对象。",
        ...
        ["LoadingDump"] = "正在加载对象 Dump…",
        ["DumpTruncated"] = "为保护内存，Dump 预览已截断",
        ["DumpLoaded"] = "对象 Dump 已加载",
        ["DumpFailed"] = "Dump 加载失败：{0}",
